...
const smallSizec = document.querySelector('#smallsize')
smallSizec.addEventListener("click", () => {
  createTempleCard(temples.filter(temple => temple.area < 10000));
  sidebarDis();
});
...
const oldBtnc = document.querySelector('.oldBtn')
oldBtnc.addEventListener("click", () => {
  createTempleCard(temples.filter(temple => parseInt(temple.dedicated.split(",")[0]) < 1900));
  sidebarDis();
});
...
const newOnesC = document.querySelector('.newones')
newOnesC.addEventListener("click", () => {
  createTempleCard(temples.filter(temple => parseInt(temple.dedicated.split(",")[0]) > 2000));
  sidebarDis();
});
